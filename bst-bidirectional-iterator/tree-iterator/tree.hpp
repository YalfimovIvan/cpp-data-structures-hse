...
struct tree
{
    ...
    struct iterator
    {
        ...
        bool operator!=(iterator const &other) const { return p != other.p; }
        // Эти два метода нужно реализовать
